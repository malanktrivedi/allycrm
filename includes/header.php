...
<meta name="description" content="Ally CRM — customer relationships, organized around your business.">
...
<a class="<?= $active==='features'?'active':''?>" href="/features.php">Features</a>
<a class="<?= $active==='solutions'?'active':''?>" href="/solutions.php">Solutions</a>
<a class="<?= $active==='pricing'?'active':''?>" href="/pricing.php">Pricing</a>
<a class="<?= $active==='startup'?'active':''?>" href="/startup-program.php">Startup Program</a>
<a class="<?= $active==='docs'?'active':''?>" href="/docs/">Docs</a><a class="<?= $active==='api'?'active':''?>" href="/api/">API</a>
<a class="<?= $active==='support'?'active':''?>" href="/support.php">Support</a></nav>
