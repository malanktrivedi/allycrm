...
<header class="site-header">
  <div class="container nav-wrap">
    ...
    <nav class="main-nav" aria-label="Primary navigation">
      <div class="nav-item"><button class="nav-trigger">Platform</button><div class="nav-menu"><a href="/crm.php">Lead Management</a><a href="/channels.php">Unified Inbox</a><a href="/features.php">Platform Features</a><a href="/ai/command-center/">AI Command Center</a><a href="/ai/workflow-builder/">Agentic Workflow Builder</a><a href="/pricing.php">Plans &amp; Pricing</a></div></div>
